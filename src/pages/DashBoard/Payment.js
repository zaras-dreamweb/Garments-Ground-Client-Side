...
const Payment = () => {
    const { id } = useParams();
    const url = `https://whispering-badlands-42201.herokuapp.com/order/${id}`;
    ...
    return (
        <div>
            ...
            <div className='ml-2'>
                <div className="card w-50 max-w-md bg-success shadow-xl my-14">
                ...
                <div className="card flex-shrink-0 w-50 max-w-md shadow-2xl bg-success">
                    <div className="card-body">
