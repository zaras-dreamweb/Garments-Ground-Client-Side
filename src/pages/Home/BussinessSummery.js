            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-10 ml-8'>
                < div className="card w-96 bg-base-100" >
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-6xl text-blue-400"><FontAwesomeIcon icon={faPeopleGroup}></FontAwesomeIcon></h2>
                ...
                < div className="card w-96 bg-base-100" >
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-6xl text-blue-400"><FontAwesomeIcon icon={faShippingFast}></FontAwesomeIcon></h2>
                ...
                < div className="card w-96 bg-base-100" >
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-6xl text-blue-400"><FontAwesomeIcon icon={faFlagCheckered}></FontAwesomeIcon></h2>
